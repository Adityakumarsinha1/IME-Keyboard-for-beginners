...
public class CandidateView extends View {
    ...
    public CandidateView(Context context) {
        ...
        setBackgroundColor(r.getColor(androidx.cardview.R.color.cardview_dark_background));

        mColorNormal = r.getColor(R.color.black);
        mColorRecommended = r.getColor(androidx.cardview.R.color.cardview_light_background);
